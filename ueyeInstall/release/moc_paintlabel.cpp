...
static const char qt_meta_stringdata_PaintLabel[] = {
    "PaintLabel\0\0clear()\0"
};
...
const QMetaObjectExtraData PaintLabel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PaintLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_PaintLabel,
      qt_meta_data_PaintLabel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PaintLabel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PaintLabel))
