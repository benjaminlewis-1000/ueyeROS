 ...
 *
 * \brief   properties tab widget for camera input/outputs
 *
...
void properties::UpdateInputCtrls ()
{
    ...
    sliderTriggerDelay->setMinValue (m_minTriggerDelay);
    sliderTriggerDelay->setMaxValue (m_maxTriggerDelay);
    ...
    // update spin control
    spinBoxTriggerDelay->setMinValue (m_minTriggerDelay);
    spinBoxTriggerDelay->setMaxValue (m_maxTriggerDelay);
...
void properties::UpdateOutputCtrls ()
{
    ...
    // update slider control
    sliderFlashDelay->setMinValue (0);
    sliderFlashDelay->setMaxValue (m_maxFlashDelay);
    sliderFlashDelay->setSteps (m_incFlashDelay, 200*m_incFlashDelay );
    sliderFlashDelay->setValue (m_nFlashDelay);
    sliderFlashDelay->setEnabled (flashActive);
    // update spin control
    spinBoxFlashDelay->setMinValue (0);
    spinBoxFlashDelay->setMaxValue (m_maxFlashDelay);
    ...
    // update slider control
    sliderFlashDuration->setMinValue (0);
    sliderFlashDuration->setMaxValue (m_maxFlashDuration);
    sliderFlashDuration->setSteps (m_incFlashDuration, 200*m_incFlashDuration );
    sliderFlashDuration->setValue (m_nFlashDuration);
    sliderFlashDuration->setEnabled (flashActive);
    // update spin control
    spinBoxFlashDuration->setMinValue (0);
    spinBoxFlashDuration->setMaxValue (m_maxFlashDuration);
...
void properties::pushButtonWriteEEPROM_clicked ()
{
    ...
    strncpy (str, lineEditEepromEntry->text (), IS_EEPROM_MAX_USER_SPACE);
    // get values
