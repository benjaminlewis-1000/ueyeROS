 ...
 * \li  06.09.2010 - check software gamma support within initTabImage(), cause of "XS" (Mantis 2923)
 * \li  15.04.2011 - automatic control update
 * \li  16.05.2012 - Changes to use new functions
 * \li  08.01.2013 - Changes to use new is_Gamma function which replaces is_SetGamma
 */
